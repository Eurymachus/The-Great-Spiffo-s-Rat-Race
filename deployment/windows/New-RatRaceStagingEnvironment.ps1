...
$copiedNames = @(
    ...
    "MICROSOFT_GRAPH_REPLY_TO", "DEFAULT_FROM_EMAIL"
)
...
$lines = @(
    ...
    "OPENAI_API_KEY=STAGING_NOT_CONFIGURED"
    "TWITCH_CLIENT_ID=STAGING_NOT_CONFIGURED"
    "TWITCH_CLIENT_SECRET=STAGING_NOT_CONFIGURED"
    "DISCORD_CLIENT_ID=STAGING_NOT_CONFIGURED"
    "DISCORD_CLIENT_SECRET=STAGING_NOT_CONFIGURED"
    "YOUTUBE_CLIENT_ID=STAGING_NOT_CONFIGURED"
    "YOUTUBE_CLIENT_SECRET=STAGING_NOT_CONFIGURED"
    "STEAMCMD_USERNAME=STAGING_NOT_CONFIGURED"
    "STEAM_WEB_API_KEY=STAGING_NOT_CONFIGURED"
) | ForEach-Object { $_ }
